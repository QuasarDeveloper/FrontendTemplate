...
<template>
  <div class="q-pa-md">
    <q-layout view="hHh LpR fFf">
      <!-- Header: -->
      <q-header v-model="showMenuBar" class="text-left bg-blue-10" elevated reveal>
        <!-- Menu bar: -->
        <q-toolbar>
      ...
      <!-- Status bar: -->
      <q-footer v-model="showStatusBar" class="bg-blue-10" elevated reveal>
        <q-toolbar>
          <q-toolbar-title class="text-center my-title"> &copy; QuasarDeveloper - frontend template 2024</q-toolbar-title>
        </q-toolbar>
      </q-footer>
